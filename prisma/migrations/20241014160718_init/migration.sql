...
-- AddForeignKey
ALTER TABLE "Announcement" ADD CONSTRAINT "Announcement_announcementId_fkey" FOREIGN KEY ("announcementId") REFERENCES "Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
